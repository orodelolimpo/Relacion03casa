...
public class Ejerciciorep17 {

	public static void main(String[] args) {
		// 17. Implementar el ejercicio 7 de la práctica 2, introduciendo un esquema do-while,
		//de forma que el usuario decida cuando quiere salir del programa.
